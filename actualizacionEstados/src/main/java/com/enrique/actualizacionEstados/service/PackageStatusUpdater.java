...
public class PackageStatusUpdater {
    ...
    private final KafkaTemplate<String, Pack> kafkaTemplate;
    private final PackageRepository packageRepository;

    public PackageStatusUpdater(KafkaTemplate<String, Pack> kafkaTemplate, PackageRepository packageRepository) {
    ...
    public void updateStatus() {
        for (Pack pkg : packageRepository.findAll()) {
            ...
            kafkaTemplate.send("package-status-updates", pkg.getId(), pkg);
        }
